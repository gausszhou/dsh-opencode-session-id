 ...
 * @param input - the session id to hash.
...
function apply(ctx, config = {}) {
	...
	const wireSessionId = (raw) => cfg.nanoidSessionId ? nanoidOf(raw, cfg.nanoidLength, NANOID_ALPHABETS[cfg.nanoidAlphabet]) : raw;
	const envFallback = () => {
...
export { DEFAULT_HEADERS, NANOID_ALPHABET, NANOID_ALPHABET_URLSAFE, SessionId, apply, createSessionScope, inject, installSessionHeaderFetch, matchesTarget, name, nanoidOf, normalize, scopedIterable, withSessionHeaders };
